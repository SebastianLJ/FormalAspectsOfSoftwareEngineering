...
structure ColouringBasics =
    struct
        ...
        fun areNb'5E1_ (cn1'64B_, cn2'650_, r'655_) = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory1/ColouringBasics.rsl", (17, 7)); (RT_s_2.R_mem ((cn1'64B_, cn2'650_), r'655_)) orelse (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory1/ColouringBasics.rsl", (17, 28)); RT_s_2.R_mem ((cn2'650_, cn1'64B_), r'655_)));
        
        fun isCorrectColouring'771_ (cols'7E8_, r'7EE_) = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory1/ColouringBasics.rsl", (22, 7)); (((RT_s_4.R_all (fn (col'8A4_:RT_s_3.t) => ((RT_s_3.R_all (fn (cn'90A_:RT_Text.t) => ((RT_s_2.R_exists (fn ((cn1'974_, cn2'978_):RT_x_1.t) => ((RT_Text.equ (cn'90A_, cn1'974_)) orelse (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory1/ColouringBasics.rsl", (25, 26)); RT_Text.equ (cn'90A_, cn2'978_)))) (r'7EE_)))) (col'8A4_)))) (cols'7E8_)))) andalso (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory1/ColouringBasics.rsl", (31, 7)); (((RT_s_4.R_all (fn (col1'C28_:RT_s_3.t) => ((RT_s_4.R_all (fn (col2'C8E_:RT_s_3.t) => ((RSL.C_not RT_s_3.equ) (col1'C28_, col2'C8E_)) andalso (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory1/ColouringBasics.rsl", (33, 27)); RT_s_3.equ (RT_s_3.R_inter (col1'C28_, col2'C8E_), RT_s_3.R_fromList []))) (cols'7E8_)))) (cols'7E8_)))) andalso (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory1/ColouringBasics.rsl", (38, 7)); (((RT_s_2.R_all (fn ((cn1'EE5_, cn2'EEA_):RT_x_1.t) => ((RT_s_4.R_exists (fn (col1'F4D_:RT_s_3.t) => ((RT_s_4.R_exists (fn (col2'FB3_:RT_s_3.t) => (RT_s_3.R_mem (cn1'EE5_, col1'F4D_)) andalso (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory1/ColouringBasics.rsl", (41, 30)); RT_s_3.R_mem (cn2'EEA_, col2'FB3_))) (cols'7E8_)))) (cols'7E8_)))) (r'7EE_)))) andalso (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory1/ColouringBasics.rsl", (47, 7)); ((RT_s_4.R_all (fn (col'1268_:RT_s_3.t) => ((RT_s_3.R_all (fn (cn1'12CE_:RT_Text.t) => ((RT_s_3.R_all (fn (cn2'1334_:RT_Text.t) => RT_Bool.equ (((areNb'5E1_) (cn1'12CE_, cn2'1334_, r'7EE_)), false)) (col'1268_)))) (col'1268_)))) (cols'7E8_)))))));
        
        fun isRelation'451_ r'4C0_ = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory1/ColouringBasics.rsl", (13, 7)); ((RT_s_2.R_all (fn ((cn1'521_, cn2'526_):RT_x_1.t) => (((RSL.C_not RT_Text.equ) (cn1'521_, cn2'526_)) andalso (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory1/ColouringBasics.rsl", (13, 79)); ((RSL.C_not RT_Text.equ) (cn1'521_, RT_Text.fromLit "")) andalso (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory1/ColouringBasics.rsl", (13, 92)); (RSL.C_not RT_Text.equ) (cn2'526_, RT_Text.fromLit ""))))) (r'4C0_))));
