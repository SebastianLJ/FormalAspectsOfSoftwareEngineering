...
structure TESTNET =
    struct
        ...
        fun allStopsHaveConnection'5591_ (capacityMap'560C_, connectionMap'5619_) = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (79, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'560C_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'5619_))))) then raise RSL.RSL_exception ("/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl:77:5: Argument of allStopsHaveConnection" ^ RT_x_5.toString (capacityMap'560C_, connectionMap'5619_) ^ " not in subtype") else ((RT_m_1.R_all (fn (stopId'5660_:RT_Text.t) => ((RT_m_1.R_exists (fn (stopId2'572D_:RT_Text.t) => ((RT_m_4.R_mem ((stopId'5660_, stopId2'572D_), (connectionMap'5619_))) orelse (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (84, 13)); RT_m_4.R_mem ((stopId2'572D_, stopId'5660_), (connectionMap'5619_))))) ((capacityMap'560C_))))) ((capacityMap'560C_)))));
        
        fun noSelfConnection'5019_ (capacityMap'508E_, connectionMap'509B_) = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (65, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'508E_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'536E_))))) then raise RSL.RSL_exception ("/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl:70:5: Argument of allStopsInConnectionMapAreInCapacityMap" ^ RT_x_5.toString (capacityMap'5361_, connectionMap'536E_) ^ " not in subtype") else ((RT_m_4.R_all (fn ((stopId1'53A5_, stopId2'53AE_):RT_x_2.t) => (RT_m_1.R_mem (stopId1'53A5_, (capacityMap'5361_))) andalso (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (74, 42)); RT_m_1.R_mem (stopId2'53AE_, (capacityMap'5361_)))) ((connectionMap'536E_)))));
        
        fun isWellformed'5979_ net'59EA_ = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (89, 7)); if not(let
        ...
        end) then raise RSL.RSL_exception ("/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl:87:5: Argument of isWellformed" ^ "(" ^ RT_x_5.toString net'59EA_ ^ ")" ^ " not in subtype") else (((noSelfConnection'5019_) (net'59EA_))) andalso (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (90, 7)); (((allStopsInConnectionMapAreInCapacityMap'52D5_) (net'59EA_))) andalso (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (91, 7)); ((allStopsHaveConnection'5591_) (net'59EA_)))));
        
        val empty'3C91_ = (RT_m_1.R_fromList [], RT_m_4.R_fromList []);
        
        fun minDrivingTime'4C95_ (stopId1'4D08_, stopId2'4D11_, (capacityMap'4D1B_, connectionMap'4D28_)) = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (56, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'4D1B_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'4D28_))))) then raise RSL.RSL_exception ("/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl:54:5: Argument of minDrivingTime" ^ RT_x_12.toString (stopId1'4D08_, stopId2'4D11_, (capacityMap'4D1B_, connectionMap'4D28_)) ^ " not in subtype") else let
            val (headway'4D64_, drivingTime'4D6D_, capacity'4D7A_) = ((((RT_m_4.R_app(connectionMap'4D28_)) (stopId1'4D08_, stopId2'4D11_))):RT_x_3.t)
        in
            drivingTime'4D6D_
        end);
        
        fun insertStop'3D59_ (stopId'3DC8_, capacity'3DD0_, (capacityMap'3DDB_, connectionMap'3DE8_)) = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (17, 7)); if not((RT_Nat.R_ge (capacity'3DD0_, RT_Int.fromLit "0")) andalso (((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'3DDB_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'3DE8_)))))) then raise RSL.RSL_exception ("/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl:15:5: Argument of insertStop" ^ RT_x_6.toString (stopId'3DC8_, capacity'3DD0_, (capacityMap'3DDB_, connectionMap'3DE8_)) ^ " not in subtype") else (RT_m_1.R_override (capacityMap'3DDB_, RT_m_1.R_fromList ([(stopId'3DC8_, capacity'3DD0_)])), connectionMap'3DE8_));
        
        fun capacity'4975_ (stopId1'49E2_, stopId2'49EB_, (capacityMap'49F5_, connectionMap'4A02_)) = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (48, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'49F5_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'3FFF_)))))))) then raise RSL.RSL_exception ("/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl:20:5: Argument of addConnection" ^ RT_x_9.toString (stopId1'3FBF_, stopId2'3FC8_, headway'3FD1_, capacity'3FDA_, drivingTime'3FE4_, (capacityMap'3FF2_, connectionMap'3FFF_)) ^ " not in subtype") else (capacityMap'3FF2_, RT_m_4.R_override (connectionMap'3FFF_, RT_m_4.R_fromList ([((stopId1'3FBF_, stopId2'3FC8_), (headway'3FD1_, drivingTime'3FE4_, capacity'3FDA_))]))));
        
        fun minHeadway'4655_ (stopId1'46C4_, stopId2'46CD_, (capacityMap'46D7_, connectionMap'46E4_)) = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (40, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'46D7_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'46E4_))))) then raise RSL.RSL_exception ("/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl:38:5: Argument of minHeadway" ^ RT_x_12.toString (stopId1'46C4_, stopId2'46CD_, (capacityMap'46D7_, connectionMap'46E4_)) ^ " not in subtype") else let
            val (headway'4724_, drivingTime'472D_, capacity'473A_) = ((((RT_m_4.R_app(connectionMap'46E4_)) (stopId1'46C4_, stopId2'46CD_))):RT_x_3.t)
        in
            headway'4724_
        end);
        
        fun isIn'4141_ (stopId'41AA_, (capacityMap'41B3_, connecitonMap'41C0_)) = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (27, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'41B3_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connecitonMap'41C0_))))) then raise RSL.RSL_exception ("/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl:25:5: Argument of isIn" ^ RT_x_10.toString (stopId'41AA_, (capacityMap'41B3_, connecitonMap'41C0_)) ^ " not in subtype") else RT_m_1.R_mem (stopId'41AA_, (capacityMap'41B3_)));
        
        fun areDirectlyConnected'4461_ (stopId1'44DA_, stopId2'44E3_, (capacityMap'44ED_, connectionMap'44FA_)) = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (35, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'44ED_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'44FA_))))) then raise RSL.RSL_exception ("/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl:33:5: Argument of areDirectlyConnected" ^ RT_x_12.toString (stopId1'44DA_, stopId2'44E3_, (capacityMap'44ED_, connectionMap'44FA_)) ^ " not in subtype") else RT_m_4.R_mem ((stopId1'44DA_, stopId2'44E3_), (connectionMap'44FA_)));
        
        fun capacity'42D1_ (stopId'433F_, (capacityMap'4347_, connectionMap'4354_)) = (R_coverage.cancel(RT_Text.fromLit "/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl", (31, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'4347_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'4354_))))) then raise RSL.RSL_exception ("/home/noah/Documents/FormalAspectsOfSoftwareEngineering/mandatory2/NET.rsl:29:5: Argument of capacity" ^ RT_x_10.toString (stopId'433F_, (capacityMap'4347_, connectionMap'4354_)) ^ " not in subtype") else ((RT_m_1.R_app(capacityMap'4347_)) (stopId'433F_)));
