...
structure testTimeTable =
    struct
        ...
        fun areDirectlyConnected'F875_ (stopId1'F8EE_, stopId2'F8F7_, (capacityMap'F901_, connectionMap'F90E_)) = (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (36, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'F901_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'F90E_))))) then raise RSL.RSL_exception ("./NET.rsl:34:5: Argument of areDirectlyConnected" ^ RT_x_12.toString (stopId1'F8EE_, stopId2'F8F7_, (capacityMap'F901_, connectionMap'F90E_)) ^ " not in subtype") else (RT_m_4.R_mem ((stopId1'F8EE_, stopId2'F8F7_), (connectionMap'F90E_))) orelse (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (37, 7)); RT_m_4.R_mem ((stopId2'F8F7_, stopId1'F8EE_), (connectionMap'F90E_))));
        
        fun allStopsHaveConnection'10F1D_ (capacityMap'10F98_, connectionMap'10FA5_) = (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (94, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'10F98_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'10FA5_))))) then raise RSL.RSL_exception ("./NET.rsl:92:5: Argument of allStopsHaveConnection" ^ RT_x_5.toString (capacityMap'10F98_, connectionMap'10FA5_) ^ " not in subtype") else ((RT_m_1.R_all (fn (stopId'10FEC_:RT_Text.t) => ((RT_m_1.R_exists (fn (stopId2'110B9_:RT_Text.t) => (((areDirectlyConnected'F875_) (stopId'10FEC_, stopId2'110B9_, (capacityMap'10F98_, connectionMap'10FA5_))))) ((capacityMap'10F98_))))) ((capacityMap'10F98_)))));
        
        fun noSelfConnection'109A5_ (capacityMap'10A1A_, connectionMap'10A27_) = (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (80, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'10A1A_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'10A27_))))) then raise RSL.RSL_exception ("./NET.rsl:78:5: Argument of noSelfConnection" ^ RT_x_5.toString (capacityMap'10A1A_, connectionMap'10A27_) ^ " not in subtype") else ((RT_m_4.R_all (fn ((stopId1'10A75_, stopId2'10A7E_):RT_x_2.t) => (RSL.C_not RT_Text.equ) (stopId1'10A75_, stopId2'10A7E_)) ((connectionMap'10A27_)))));
        
        fun isIn'F555_ (stopId'F5BE_, (capacityMap'F5C7_, connecitonMap'F5D4_)) = (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (28, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'F5C7_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connecitonMap'F5D4_))))) then raise RSL.RSL_exception ("./NET.rsl:26:5: Argument of isIn" ^ RT_x_10.toString (stopId'F5BE_, (capacityMap'F5C7_, connecitonMap'F5D4_)) ^ " not in subtype") else RT_m_1.R_mem (stopId'F5BE_, (capacityMap'F5C7_)));
        
        fun allStopsInConnectionMapAreInCapacityMap'10C61_ (capacityMap'10CED_, connectionMap'10CFA_) = (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (87, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'10CED_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'10CFA_))))) then raise RSL.RSL_exception ("./NET.rsl:85:5: Argument of allStopsInConnectionMapAreInCapacityMap" ^ RT_x_5.toString (capacityMap'10CED_, connectionMap'10CFA_) ^ " not in subtype") else ((RT_m_4.R_all (fn ((stopId1'10D31_, stopId2'10D3A_):RT_x_2.t) => (((isIn'F555_) (stopId1'10D31_, (capacityMap'10CED_, connectionMap'10CFA_)))) andalso (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (89, 56)); ((isIn'F555_) (stopId2'10D3A_, (capacityMap'10CED_, connectionMap'10CFA_))))) ((connectionMap'10CFA_)))));
        
        fun isWellformed'112A1_ net'11312_ = (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (103, 7)); if not(let
        ...
        end) then raise RSL.RSL_exception ("./NET.rsl:101:5: Argument of isWellformed" ^ "(" ^ RT_x_5.toString net'11312_ ^ ")" ^ " not in subtype") else (((noSelfConnection'109A5_) (net'11312_))) andalso (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (104, 7)); (((allStopsInConnectionMapAreInCapacityMap'10C61_) (net'11312_))) andalso (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (105, 7)); ((allStopsHaveConnection'10F1D_) (net'11312_)))));
        
        fun getConnection'FACD_ (stop1'FB3F_, stop2'FB46_, (capacityMap'FB4E_, connectionMap'FB5B_)) = (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (42, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'FB4E_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'FB5B_))))) then raise RSL.RSL_exception ("./NET.rsl:40:5: Argument of getConnection" ^ RT_x_12.toString (stop1'FB3F_, stop2'FB46_, (capacityMap'FB4E_, connectionMap'FB5B_)) ^ " not in subtype") else if RT_m_4.R_mem ((stop1'FB3F_, stop2'FB46_), (connectionMap'FB5B_)) then (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (44, 9)); ((RT_m_4.R_app(connectionMap'FB5B_)) ((stop1'FB3F_, stop2'FB46_)))) else (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (46, 9)); ((RT_m_4.R_app(connectionMap'FB5B_)) ((stop2'FB46_, stop1'FB3F_)))));
        
        fun minDrivingTime'105BD_ (stopId1'10630_, stopId2'10639_, net'10642_) = (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (70, 7)); if not(let
        ...
        end) then raise RSL.RSL_exception ("./NET.rsl:68:5: Argument of minDrivingTime" ^ RT_x_12.toString (stopId1'10630_, stopId2'10639_, net'10642_) ^ " not in subtype") else let
        ...
        fun minHeadway'FEB5_ (stopId1'FF24_, stopId2'FF2D_, net'FF36_) = (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (52, 7)); if not(let
        ...
        end) then raise RSL.RSL_exception ("./NET.rsl:50:5: Argument of minHeadway" ^ RT_x_12.toString (stopId1'FF24_, stopId2'FF2D_, net'FF36_) ^ " not in subtype") else let
            val (headway'FFE6_, drivingTime'FFEF_, capacity'FFFC_) = ((((getConnection'FACD_) (stopId1'FF24_, stopId2'FF2D_, net'FF36_))):RT_x_3.t)
        in
            headway'FFE6_
        end);
        
        fun capacity'F6E5_ (stopId'F753_, (capacityMap'F75B_, connectionMap'F768_)) = (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (32, 7)); if not(((RT_s_7.R_all (fn (x_'0_:RT_Nat.t) => RT_Nat.R_ge (x_'0_, RT_Int.fromLit "0")) (RT_m_1.R_ran(capacityMap'F75B_)))) andalso ((RT_s_8.R_all (fn (x_'0_:RT_x_3.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'F768_))))) then raise RSL.RSL_exception ("./NET.rsl:30:5: Argument of capacity" ^ RT_x_10.toString (stopId'F753_, (capacityMap'F75B_, connectionMap'F768_)) ^ " not in subtype") else ((RT_m_1.R_app(capacityMap'F75B_)) (stopId'F753_)));
        
        fun capacity'10239_ (stopId1'102A6_, stopId2'102AF_, net'102B8_) = (R_coverage.cancel(RT_Text.fromLit "./NET.rsl", (61, 7)); if not(let
        ...
        end) then raise RSL.RSL_exception ("./NET.rsl:59:5: Argument of capacity" ^ RT_x_12.toString (stopId1'102A6_, stopId2'102AF_, net'102B8_) ^ " not in subtype") else let
        ...
        end) (RT_m_4.R_ran(connectionMap'F1FC_)))))) then raise RSL.RSL_exception ("./NET.rsl:16:5: Argument of insertStop" ^ RT_x_6.toString (stopId'F1DC_, capacity'F1E4_, (capacityMap'F1EF_, connectionMap'F1FC_)) ^ " not in subtype") else (RT_m_1.R_override (capacityMap'F1EF_, RT_m_1.R_fromList ([(stopId'F1DC_, capacity'F1E4_)])), connectionMap'F1FC_));
        ...
        fun buildTimesForTramOnStop'9B7D_ (stopid'9BF9_, plan'9C01_, tramid'9C07_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (240, 7)); if not((RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (plan'9C01_))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:238:5: Argument of buildTimesForTramOnStop" ^ RT_x_30.toString (stopid'9BF9_, plan'9C01_, tramid'9C07_) ^ " not in subtype") else if RT_Nat.R_lt (RT_l_15.R_length(plan'9C01_), RT_Int.fromLit "1") then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (241, 12)); RT_s_27.R_fromList []) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (243, 9)); let
            val (sid'9DDC_, arrt'9DE1_, dept'9DE7_) = ((RT_l_15.R_hd(plan'9C01_)):RT_x_14.t)
        in
            if RT_Text.equ (sid'9DDC_, stopid'9BF9_) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (247, 16)); RT_s_27.R_union (RT_s_27.R_fromList ([(tramid'9C07_, arrt'9DE1_, dept'9DE7_)]), ((buildTimesForTramOnStop'9B7D_) (stopid'9BF9_, RT_l_15.R_tl(plan'9C01_), tramid'9C07_)))) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (248, 16)); ((buildTimesForTramOnStop'9B7D_) (stopid'9BF9_, RT_l_15.R_tl(plan'9C01_), tramid'9C07_)))
        end));
        
        fun buildAllTimesForStop'9605_ (stopid'967E_, trams'9686_, timetable'968D_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (226, 7)); if not((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (x_'0_))) (RT_m_16.R_ran(timetable'968D_)))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:224:5: Argument of buildAllTimesForStop" ^ RT_x_29.toString (stopid'967E_, trams'9686_, timetable'968D_) ^ " not in subtype") else if RT_s_11.equ (trams'9686_, RT_s_11.R_fromList []) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (227, 12)); RT_s_27.R_fromList []) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (229, 9)); let
        ...
        fun countOverlappingTimesForStop'8F61_ (tramid'8FE2_, arrtime'8FE9_, deptime'8FF2_, times'8FFB_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (209, 7)); if not((RT_Nat.R_ge (arrtime'8FE9_, RT_Int.fromLit "0")) andalso ((RT_Nat.R_ge (deptime'8FF2_, RT_Int.fromLit "0")) andalso ((RT_s_27.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (times'8FFB_))))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:207:5: Argument of countOverlappingTimesForStop" ^ RT_x_28.toString (tramid'8FE2_, arrtime'8FE9_, deptime'8FF2_, times'8FFB_) ^ " not in subtype") else if RT_s_27.equ (times'8FFB_, RT_s_27.R_fromList []) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (210, 12)); RT_Int.fromLit "0") else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (212, 9)); let
            val (tramid2'91C0_, arrtime2'91C9_, deptime2'91D3_) = ((RT_s_27.R_hd(times'8FFB_)):RT_x_14.t)
        in
            if ((RSL.C_not RT_Text.equ) (tramid'8FE2_, tramid2'91C0_)) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (215, 35)); ((((RT_Nat.R_lt (arrtime'8FE9_, arrtime2'91C9_)) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (215, 59)); RT_Nat.R_lt (arrtime2'91C9_, deptime'8FF2_)))) orelse (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (215, 81)); ((RT_Nat.R_lt (arrtime'8FE9_, deptime2'91D3_)) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (216, 4)); RT_Nat.R_lt (deptime2'91D3_, deptime'8FF2_)))))) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (216, 16)); RT_Nat.R_add (RT_Int.fromLit "1", ((countOverlappingTimesForStop'8F61_) (tramid'8FE2_, arrtime'8FE9_, deptime'8FF2_, RT_s_27.R_diff (times'8FFB_, RT_s_27.R_fromList ([(tramid2'91C0_, arrtime2'91C9_, deptime2'91D3_)])))))) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (217, 16)); ((countOverlappingTimesForStop'8F61_) (tramid'8FE2_, arrtime'8FE9_, deptime'8FF2_, RT_s_27.R_diff (times'8FFB_, RT_s_27.R_fromList ([(tramid2'91C0_, arrtime2'91C9_, deptime2'91D3_)])))))
        end));
        
        fun stopCapacityIsNotExceeded'CE47_ (stopid'CEC5_, timetable'CECD_, net'CED8_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (370, 9)); if not(((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end)) then raise RSL.RSL_exception ("./TIMETABLE.rsl:368:7: Argument of stopCapacityIsNotExceeded" ^ RT_x_34.toString (stopid'CEC5_, timetable'CECD_, net'CED8_) ^ " not in subtype") else let
        ...
        fun allStopCapacitiesAreNotExceeded'CB27_ (timetable'CBAB_, (capacityMap'CBB7_, connectionMap'CBC3_)) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (362, 9)); if not(((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'CBC3_)))))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:360:7: Argument of allStopCapacitiesAreNotExceeded" ^ RT_x_32.toString (timetable'CBAB_, (capacityMap'CBB7_, connectionMap'CBC3_)) ^ " not in subtype") else ((RT_m_1.R_all (fn (stopid'CBF6_:RT_Text.t) => ((stopCapacityIsNotExceeded'CE47_) (stopid'CBF6_, timetable'CBAB_, (capacityMap'CBB7_, connectionMap'CBC3_)))) ((capacityMap'CBB7_)))));
        
        fun timeBetweenStopsIsDrivingTime'A479_ (plan'A4FB_, (capacityMap'A502_, connectionMap'A50F_)) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (263, 7)); if not(((RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'A50F_)))))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:261:5: Argument of timeBetweenStopsIsDrivingTime" ^ RT_x_31.toString (plan'A4FB_, (capacityMap'A502_, connectionMap'A50F_)) ^ " not in subtype") else if RT_Nat.R_gt (RT_l_15.R_length(plan'A4FB_), RT_Int.fromLit "1") then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (264, 9)); let
        ...
        in
            ...
            in
                ((RT_Nat.R_ge (RT_Nat.R_sub (arrTime2'A67D_, depTime1'A623_), drivingTime'A7A1_))) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (271, 53)); ((timeBetweenStopsIsDrivingTime'A479_) (RT_l_15.R_tl(plan'A4FB_), (capacityMap'A502_, connectionMap'A50F_))))
            end
        end) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (275, 9)); true));
        
        fun allTimeBetweenStopsIsValidDrivingTime'ABE5_ (t'AC6F_, n'AC72_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (282, 7)); if not(((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end)) then raise RSL.RSL_exception ("./TIMETABLE.rsl:280:5: Argument of allTimeBetweenStopsIsValidDrivingTime" ^ RT_x_32.toString (t'AC6F_, n'AC72_) ^ " not in subtype") else ((RT_s_19.R_all (fn (plan'ACB4_:RT_l_15.t) => not ((RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        fun nextStop'4E8B_ (planRow'4EF8_, plan'4F01_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (43, 9)); if not((let
        ...
        end) (plan'4F01_)))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:41:7: Argument of nextStop" ^ RT_x_22.toString (planRow'4EF8_, plan'4F01_) ^ " not in subtype") else if not(RT_Nat.R_gt (RT_l_15.R_length(plan'4F01_), RT_Int.fromLit "1")) then raise RSL.RSL_exception ("./TIMETABLE.rsl:66:13: Precondition of nextStop" ^ RT_x_22.toString (planRow'4EF8_, plan'4F01_) ^ " not satisfied") else let
            val iPlanRow'4FBB_ = ((RT_l_15.R_hd(plan'4F01_)):RT_x_14.t)
        in
            if RT_x_14.equ (iPlanRow'4FBB_, planRow'4EF8_) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (48, 13)); let
                val (sid'51B4_, arrt'51B9_, dept'51BF_) = ((RT_l_15.R_hd((RT_l_15.R_tl(plan'4F01_)))):RT_x_14.t)
            in
                (sid'51B4_, arrt'51B9_, dept'51BF_)
            end) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (54, 13)); if RT_Nat.R_gt (RT_l_15.R_length((RT_l_15.R_tl(plan'4F01_))), RT_Int.fromLit "1") then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (56, 15)); ((nextStop'4E8B_) (planRow'4EF8_, RT_l_15.R_tl(plan'4F01_)))) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (58, 15)); let
        ...
        fun findDepartureRowInPlan'62D9_ (stopid1'6354_, stopid2'635D_, plan'6366_, tram'636C_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (95, 7)); if not((RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (plan'6366_))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:93:5: Argument of findDepartureRowInPlan" ^ RT_x_26.toString (stopid1'6354_, stopid2'635D_, plan'6366_, tram'636C_) ^ " not in subtype") else if not(RT_Nat.R_gt (RT_l_15.R_length(plan'6366_), RT_Int.fromLit "1")) then raise RSL.RSL_exception ("./TIMETABLE.rsl:111:11: Precondition of findDepartureRowInPlan" ^ RT_x_26.toString (stopid1'6354_, stopid2'635D_, plan'6366_, tram'636C_) ^ " not satisfied") else let
        ...
        in
            if (RT_Text.equ (hStopId'640A_, stopid1'6354_)) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (99, 33)); RT_Text.equ (nStopId'646E_, stopid2'635D_)) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (101, 11)); (tram'636C_, hStopId'640A_, hArrTime'6413_, hDepTime'641D_)) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (103, 11)); if RT_Nat.R_gt (RT_l_15.R_length(RT_l_15.R_tl(plan'6366_)), RT_Int.fromLit "1") then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (105, 13)); ((findDepartureRowInPlan'62D9_) (stopid1'6354_, stopid2'635D_, RT_l_15.R_tl(plan'6366_), tram'636C_))) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (107, 13)); (RT_Text.fromLit "", RT_Text.fromLit "", RT_Int.fromLit "0", RT_Int.fromLit "0")))
        end);
        
        fun buildAllDeparturesUsingConnection'5DC5_ (stopid1'5E4B_, stopid2'5E54_, trams'5E5D_, timetable'5E64_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (82, 7)); if not((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (x_'0_))) (RT_m_16.R_ran(timetable'5E64_)))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:80:5: Argument of buildAllDeparturesUsingConnection" ^ RT_x_25.toString (stopid1'5E4B_, stopid2'5E54_, trams'5E5D_, timetable'5E64_) ^ " not in subtype") else if RT_s_11.equ (trams'5E5D_, RT_s_11.R_fromList []) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (83, 12)); RT_s_24.R_fromList []) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (85, 9)); let
        ...
        fun getAllDepaturesUsingConnection'5A41_ (stopid1'5AC4_, stopid2'5ACD_, timetable'5AD6_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (73, 7)); if not((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (x_'0_))) (RT_m_16.R_ran(timetable'5AD6_)))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:71:5: Argument of getAllDepaturesUsingConnection" ^ RT_x_23.toString (stopid1'5AC4_, stopid2'5ACD_, timetable'5AD6_) ^ " not in subtype") else let
        ...
        fun timeBetweenDeparturesIsValidHeadway'AEA1_ (timetable'AF29_, (capacityMap'AF35_, connectionMap'AF42_)) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (289, 7)); if not(((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (plan'88E9_))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:189:5: Argument of buildTimesForTramOnTrack" ^ RT_x_26.toString (stopid1'88D7_, stopid2'88E0_, plan'88E9_, tramid'88EF_) ^ " not in subtype") else if RT_Nat.R_le (RT_l_15.R_length(plan'88E9_), RT_Int.fromLit "1") then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (192, 12)); RT_s_27.R_fromList []) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (194, 9)); let
        ...
        in
            if (RT_Text.equ (sid'8AB8_, stopid1'88D7_)) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (198, 31)); RT_Text.equ (sid2'8B1C_, stopid2'88E0_)) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (199, 16)); RT_s_27.R_union (RT_s_27.R_fromList ([(tramid'88EF_, dept'8AC3_, arrt2'8B22_)]), ((buildTimesForTramOnTrack'8859_) (stopid1'88D7_, stopid2'88E0_, RT_l_15.R_tl(plan'88E9_), tramid'88EF_)))) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (200, 16)); ((buildTimesForTramOnTrack'8859_) (stopid1'88D7_, stopid2'88E0_, RT_l_15.R_tl(plan'88E9_), tramid'88EF_)))
        end));
        
        fun buildAllTimesForTrack'82E1_ (stopid1'835B_, stopid2'8364_, trams'836D_, timetable'8374_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (177, 7)); if not((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (x_'0_))) (RT_m_16.R_ran(timetable'8374_)))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:175:5: Argument of buildAllTimesForTrack" ^ RT_x_25.toString (stopid1'835B_, stopid2'8364_, trams'836D_, timetable'8374_) ^ " not in subtype") else if RT_s_11.equ (trams'836D_, RT_s_11.R_fromList []) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (178, 12)); RT_s_27.R_fromList []) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (180, 9)); let
        ...
        fun countOverlappingTimesForTrack'7C3D_ (tramid'7CBF_, deptime'7CC6_, arrtime'7CCF_, times'7CD8_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (160, 7)); if not((RT_Nat.R_ge (deptime'7CC6_, RT_Int.fromLit "0")) andalso ((RT_Nat.R_ge (arrtime'7CCF_, RT_Int.fromLit "0")) andalso ((RT_s_27.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (times'7CD8_))))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:158:5: Argument of countOverlappingTimesForTrack" ^ RT_x_28.toString (tramid'7CBF_, deptime'7CC6_, arrtime'7CCF_, times'7CD8_) ^ " not in subtype") else if RT_s_27.equ (times'7CD8_, RT_s_27.R_fromList []) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (161, 12)); RT_Int.fromLit "0") else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (163, 9)); let
            val (tramid2'7E9C_, deptime2'7EA5_, arrtime2'7EAF_) = ((RT_s_27.R_hd(times'7CD8_)):RT_x_14.t)
        in
            if ((RSL.C_not RT_Text.equ) (tramid'7CBF_, tramid2'7E9C_)) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (166, 35)); ((((RT_Nat.R_lt (deptime'7CC6_, deptime2'7EA5_)) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (166, 59)); RT_Nat.R_lt (deptime2'7EA5_, arrtime'7CCF_)))) orelse (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (166, 81)); ((RT_Nat.R_lt (deptime'7CC6_, arrtime2'7EAF_)) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (167, 4)); RT_Nat.R_lt (arrtime2'7EAF_, arrtime'7CCF_)))))) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (167, 16)); RT_Nat.R_add (RT_Int.fromLit "1", ((countOverlappingTimesForTrack'7C3D_) (tramid'7CBF_, deptime'7CC6_, arrtime'7CCF_, RT_s_27.R_diff (times'7CD8_, RT_s_27.R_fromList ([(tramid2'7E9C_, deptime2'7EA5_, arrtime2'7EAF_)])))))) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (168, 16)); ((countOverlappingTimesForTrack'7C3D_) (tramid'7CBF_, deptime'7CC6_, arrtime'7CCF_, RT_s_27.R_diff (times'7CD8_, RT_s_27.R_fromList ([(tramid2'7E9C_, deptime2'7EA5_, arrtime2'7EAF_)])))))
        end));
        
        fun trackCapacityIsNotExceeded'C4E5_ (stopid1'C564_, stopid2'C56D_, timetable'C576_, net'C581_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (346, 8)); if not(((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end)) then raise RSL.RSL_exception ("./TIMETABLE.rsl:344:5: Argument of trackCapacityIsNotExceeded" ^ RT_x_33.toString (stopid1'C564_, stopid2'C56D_, timetable'C576_, net'C581_) ^ " not in subtype") else let
        ...
        end) (RT_m_4.R_ran(connectionMap'C262_)))))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:336:5: Argument of allTrackCapacitiesAreNotExceeded" ^ RT_x_32.toString (timetable'C24A_, (capacityMap'C256_, connectionMap'C262_)) ^ " not in subtype") else ((RT_m_4.R_all (fn ((stopid1'C295_, stopid2'C29E_):RT_x_2.t) => ((trackCapacityIsNotExceeded'C4E5_) (stopid1'C295_, stopid2'C29E_, timetable'C24A_, (capacityMap'C256_, connectionMap'C262_)))) ((connectionMap'C262_)))));
        
        fun findArrivalRowInPlan'73A5_ (stopid1'741E_, stopid2'7427_, plan'7430_, tram'7436_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (138, 7)); if not((RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (plan'7430_))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:136:5: Argument of findArrivalRowInPlan" ^ RT_x_26.toString (stopid1'741E_, stopid2'7427_, plan'7430_, tram'7436_) ^ " not in subtype") else if not(RT_Nat.R_gt (RT_l_15.R_length(plan'7430_), RT_Int.fromLit "1")) then raise RSL.RSL_exception ("./TIMETABLE.rsl:154:11: Precondition of findArrivalRowInPlan" ^ RT_x_26.toString (stopid1'741E_, stopid2'7427_, plan'7430_, tram'7436_) ^ " not satisfied") else let
        ...
        in
            if (RT_Text.equ (hStopId'74D6_, stopid1'741E_)) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (142, 33)); RT_Text.equ (nStopId'753A_, stopid2'7427_)) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (144, 11)); (tram'7436_, nStopId'753A_, nArrTime'7543_, nDepTime'754D_)) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (146, 11)); if RT_Nat.R_gt (RT_l_15.R_length(RT_l_15.R_tl(plan'7430_)), RT_Int.fromLit "1") then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (148, 13)); ((findArrivalRowInPlan'73A5_) (stopid1'741E_, stopid2'7427_, RT_l_15.R_tl(plan'7430_), tram'7436_))) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (150, 13)); (RT_Text.fromLit "", RT_Text.fromLit "", RT_Int.fromLit "0", RT_Int.fromLit "0")))
        end);
        
        fun buildAllArrivalsUsingConnection'6E91_ (stopid1'6F15_, stopid2'6F1E_, trams'6F27_, timetable'6F2E_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (125, 7)); if not((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (x_'0_))) (RT_m_16.R_ran(timetable'6F2E_)))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:123:5: Argument of buildAllArrivalsUsingConnection" ^ RT_x_25.toString (stopid1'6F15_, stopid2'6F1E_, trams'6F27_, timetable'6F2E_) ^ " not in subtype") else if RT_s_11.equ (trams'6F27_, RT_s_11.R_fromList []) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (126, 12)); RT_s_24.R_fromList []) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (128, 9)); let
        ...
        fun getAllArrivalsUsingConnection'6B0D_ (stopid1'6B8F_, stopid2'6B98_, timetable'6BA1_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (116, 7)); if not((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (x_'0_))) (RT_m_16.R_ran(timetable'6BA1_)))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:114:5: Argument of getAllArrivalsUsingConnection" ^ RT_x_23.toString (stopid1'6B8F_, stopid2'6B98_, timetable'6BA1_) ^ " not in subtype") else let
        ...
        fun timeBetweenArrivalIsValidHeadway'B6D5_ (timetable'B75A_, (capacityMap'B766_, connectionMap'B773_)) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (310, 7)); if not(((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end)) then raise RSL.RSL_exception ("./TIMETABLE.rsl:433:6: Argument of isWellformed" ^ RT_x_32.toString (t'E81B_, n'E81E_) ^ " not in subtype") else (((tramStopsAtAllStopsItPasses'BD79_) (t'E81B_))) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (436, 8)); (((timeBetweenDeparturesIsValidHeadway'AEA1_) (t'E81B_, n'E81E_))) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (437, 8)); (((timeBetweenArrivalIsValidHeadway'B6D5_) (t'E81B_, n'E81E_))) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (438, 8)); (((allTimeBetweenStopsIsValidDrivingTime'ABE5_) (t'E81B_, n'E81E_))) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (439, 8)); (((allTrackCapacitiesAreNotExceeded'C1C5_) (t'E81B_, n'E81E_))) andalso (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (440, 8)); ((allStopCapacitiesAreNotExceeded'CB27_) (t'E81B_, n'E81E_))))))));
        
        fun isIn'4C31_ (tramid'4C9A_, timetable'4CA2_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (37, 7)); if not((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (x_'0_))) (RT_m_16.R_ran(timetable'4CA2_)))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:35:5: Argument of isIn" ^ RT_x_18.toString (tramid'4C9A_, timetable'4CA2_) ^ " not in subtype") else RT_m_16.R_mem (tramid'4C9A_, (timetable'4CA2_)));
        
        fun stopsExist'E105_ (plan'E174_, net'E17A_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (418, 7)); if not(((RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end)) then raise RSL.RSL_exception ("./TIMETABLE.rsl:416:5: Argument of stopsExist" ^ RT_x_31.toString (plan'E174_, net'E17A_) ^ " not in subtype") else if RT_Nat.equ (RT_l_15.R_length(plan'E174_), RT_Int.fromLit "0") then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (419, 12)); true) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (421, 9)); let
            val (sid'E364_, arrt'E369_, dept'E36F_) = ((RT_l_15.R_hd(plan'E174_)):RT_x_14.t)
        in
            if ((isIn'F555_) (sid'E364_, net'E17A_)) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (425, 16)); ((stopsExist'E105_) (RT_l_15.R_tl(plan'E174_), net'E17A_))) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (426, 16)); false)
        end));
        
        fun addPlan'4913_ (tramid'497F_, plan'4987_, timetable'498D_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (29, 9)); if not(((RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (x_'0_))) (RT_m_16.R_ran(timetable'498D_))))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:27:7: Argument of addPlan" ^ RT_x_21.toString (tramid'497F_, plan'4987_, timetable'498D_) ^ " not in subtype") else RT_m_16.R_override (timetable'498D_, RT_m_16.R_fromList ([(tramid'497F_, plan'4987_)])));
        
        fun allStopsInPlanExist'DDE5_ (timetable'DE5D_, net'DE68_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (410, 7)); if not(((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end)) then raise RSL.RSL_exception ("./TIMETABLE.rsl:408:5: Argument of allStopsInPlanExist" ^ RT_x_32.toString (timetable'DE5D_, net'DE68_) ^ " not in subtype") else ((RT_m_16.R_all (fn (tramid'DEB4_:RT_Text.t) => ((stopsExist'E105_) (((RT_m_16.R_app(timetable'DE5D_)) (tramid'DEB4_)), net'DE68_))) ((timetable'DE5D_)))));
        
        fun addStop'471F_ (tramid'478B_, stopid'4793_, arrival'479B_, departure'47A4_, timetable'47AF_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (24, 9)); if not((RT_Nat.R_ge (arrival'479B_, RT_Int.fromLit "0")) andalso ((RT_Nat.R_ge (departure'47A4_, RT_Int.fromLit "0")) andalso ((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (x_'0_))) (RT_m_16.R_ran(timetable'47AF_)))))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:22:7: Argument of addStop" ^ RT_x_20.toString (tramid'478B_, stopid'4793_, arrival'479B_, departure'47A4_, timetable'47AF_) ^ " not in subtype") else RT_m_16.R_override (timetable'47AF_, RT_m_16.R_fromList ([(tramid'478B_, RT_l_15.R_concat (((RT_m_16.R_app(timetable'47AF_)) (tramid'478B_)), [(stopid'4793_, arrival'479B_, departure'47A4_)]))])));
        
        fun stopsAreConnected'D6DF_ (plan'D755_, connectionMap'D75B_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (392, 9)); if not(((RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'D75B_))))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:390:7: Argument of stopsAreConnected" ^ RT_x_35.toString (plan'D755_, connectionMap'D75B_) ^ " not in subtype") else if RT_Nat.R_le (RT_l_15.R_length(plan'D755_), RT_Int.fromLit "1") then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (393, 14)); true) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (395, 11)); let
        ...
        in
            if (RT_m_4.R_mem ((sid'D93E_, sid2'D9A2_), (connectionMap'D75B_))) orelse (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (399, 54)); RT_m_4.R_mem ((sid2'D9A2_, sid'D93E_), (connectionMap'D75B_))) then (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (400, 18)); ((stopsAreConnected'D6DF_) (RT_l_15.R_tl(plan'D755_), connectionMap'D75B_))) else (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (401, 18)); false)
        end));
        
        fun addTram'452B_ (tramid'4597_, timetable'459F_) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (19, 9)); if not((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (x_'0_))) (RT_m_16.R_ran(timetable'459F_)))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:17:7: Argument of addTram" ^ RT_x_18.toString (tramid'4597_, timetable'459F_) ^ " not in subtype") else RT_m_16.R_override (timetable'459F_, RT_m_16.R_fromList ([(tramid'4597_, ([]:RT_l_15.t))])));
        
        fun allStopsAreConnected'D3BF_ (timetable'D438_, (capacityMap'D444_, connectionMap'D450_)) = (R_coverage.cancel(RT_Text.fromLit "./TIMETABLE.rsl", (384, 9)); if not(((RT_s_19.R_all (fn (x_'0_:RT_l_15.t) => (RT_l_15.R_all (fn (x_'0_:RT_x_14.t) => let
        ...
        end) (RT_m_4.R_ran(connectionMap'D450_)))))) then raise RSL.RSL_exception ("./TIMETABLE.rsl:382:7: Argument of allStopsAreConnected" ^ RT_x_32.toString (timetable'D438_, (capacityMap'D444_, connectionMap'D450_)) ^ " not in subtype") else ((RT_m_16.R_all (fn (tramid'D48E_:RT_Text.t) => ((stopsAreConnected'D6DF_) (((RT_m_16.R_app(timetable'D438_)) (tramid'D48E_)), connectionMap'D450_))) ((timetable'D438_)))));
        ...
        end) (x_'0_))) (RT_m_16.R_ran(z__'4411_)))) then (RSL.add_load_err("./TIMETABLE.rsl:14:25: Value " ^ RT_m_16.toString(z__'4411_) ^ " of empty not in subtype"); z__'4411_) else z__'4411_ end;
        ...
        end) (z__'1A47_))) then (RSL.add_load_err("./testTimeTable.rsl:67:27: Value " ^ RT_l_15.toString(z__'1A47_) ^ " of plan11 not in subtype"); z__'1A47_) else z__'1A47_ end;
...
RSL.set_time();
R_coverage.init();
(R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (384, 9), (386, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (19, 9), (19, 38));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (399, 54), (400, 16));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (401, 18), (402, 13));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (400, 18), (401, 16));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (395, 11), (404, 9));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (393, 14), (394, 12));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (392, 9), (404, 12));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (24, 9), (24, 86));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (410, 7), (412, 8));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (29, 9), (31, 7));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (426, 16), (427, 11));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (425, 16), (426, 14));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (421, 9), (429, 7));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (419, 12), (420, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (418, 7), (429, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (37, 7), (37, 33));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (440, 8), (441, 3));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (439, 8), (441, 3));
...
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (327, 7), (331, 8));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (317, 11), (321, 11));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (310, 7), (322, 8));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (116, 7), (120, 10));
...
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (138, 7), (154, 23));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (338, 7), (340, 8));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (353, 15), (356, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (346, 8), (356, 11));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (167, 4), (167, 22));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (166, 59), (166, 76));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (166, 81), (167, 23));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (166, 35), (167, 14));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (168, 16), (169, 11));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (167, 16), (168, 14));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (163, 9), (171, 7));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (161, 12), (162, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (160, 7), (171, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (180, 9), (185, 7));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (178, 12), (179, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (177, 7), (185, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (198, 31), (199, 14));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (200, 16), (201, 11));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (199, 16), (200, 14));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (194, 9), (203, 7));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (192, 12), (193, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (191, 7), (203, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (296, 11), (300, 11));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (289, 7), (301, 8));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (73, 7), (77, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (85, 9), (90, 7));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (83, 12), (84, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (82, 7), (90, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (107, 13), (108, 11));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (105, 13), (106, 14));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (99, 33), (100, 12));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (103, 11), (109, 9));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (101, 11), (102, 12));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (95, 7), (111, 23));
...
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (282, 7), (283, 48));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (271, 53), (272, 13));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (275, 9), (276, 7));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (264, 9), (274, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (263, 7), (276, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (362, 9), (364, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (370, 9), (377, 12));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (216, 4), (216, 22));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (215, 59), (215, 76));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (215, 81), (216, 23));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (215, 35), (216, 14));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (217, 16), (218, 11));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (216, 16), (217, 14));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (212, 9), (220, 7));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (210, 12), (211, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (209, 7), (220, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (229, 9), (234, 7));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (227, 12), (228, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (226, 7), (234, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (248, 16), (249, 11));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (247, 16), (248, 14));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (243, 9), (251, 7));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (241, 12), (242, 10));
R_coverage.mark(RT_Text.fromLit "./TIMETABLE.rsl", (240, 7), (253, 7));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (18, 7), (18, 59));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (23, 7), (24, 7));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (61, 7), (65, 10));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (32, 7), (32, 26));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (52, 7), (56, 10));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (70, 7), (76, 7));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (46, 9), (47, 7));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (44, 9), (45, 10));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (42, 7), (47, 10));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (105, 7), (106, 3));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (104, 7), (106, 3));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (103, 7), (106, 3));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (89, 56), (89, 99));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (87, 7), (90, 0));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (28, 7), (28, 35));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (80, 7), (82, 28));
R_coverage.mark(RT_Text.fromLit "./NET.rsl", (94, 7), (98, 84));
